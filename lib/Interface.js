  ...
  async _onMessageQueued(opt) {
    ...
    if (!this._shuttingDown) {
      ...
      switch (messageKey) {
        ...
        case 'setLogLevel':
          if (messageContent.level === 'DEBUG') {
            logger.level = 'debug';
          } else if (messageContent.level === 'INFO') {
            logger.level = 'info';
          } else if (messageContent.level === 'WARNING') {
            logger.level = 'warn';
          } else if (messageContent.level === 'ERROR') {
            logger.level = 'error';
          } else if (messageContent.level === 'CRITICAL') {
            logger.level = 'error';
          }else {
            logger.level = 'debug';
          }
